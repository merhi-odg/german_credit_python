...
Model code includes a metrics function used to compute Bias, Performance, Drift, Interpretability, and other metrics.
The metrics function expects **TWO** DataFrames.

### Sample Inputs

Choose **BOTH** of
 - `df_baseline_scored.json` and
